...
st.set_page_config(
    page_title="Akshar | Reading Screener",
    page_icon="👁️",
    layout="wide",
)
...
function updateUI() {{
    ...
    if (metrics.risk < 30) {{
        ...
        riskText = "Low reading-movement screening score";

    }} else if (metrics.risk < 60) {{

        riskText = "Moderate reading-movement screening score";

    }} else {{

        riskText = "Higher reading-movement screening score";
    ...
    */
    ...
    if (
        ...
        */
        ...
        /*
           ===============================================================
           AKSHAR READING-MOVEMENT RISK SCORE
           ===============================================================

           This is an experimental screening score.
           It is NOT a probability of dyslexia and NOT a diagnosis.
        */
        ...
        if (fixationRate > 8) {{
            fixationScore = 25;
        }} else if (fixationRate > 5) {{
            fixationScore = 15;
        }} else if (fixationRate > 3) {{
            fixationScore = 8;
        }}
...
function stopSession() {{
    ...
    /* Send final values to Streamlit */
    sendToStreamlit();
    ...
    document.getElementById("riskText").innerHTML =
        "Final observed reading-movement score: " +
        "<b style='color:#ff0080'>" +
        metrics.risk +
        "</b>";

    /* Log results for debugging */
    console.log(
        "AKSHAR FINAL RESULTS:",
        metrics
    );
